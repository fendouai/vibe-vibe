  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="border-b border-border-light px-4 py-4">
        <p className="text-sm font-medium text-text-heading">Todo App</p>
      </header>
      ...
      <footer className="border-t border-border-light px-4 py-4 text-center text-xs text-text-muted">
