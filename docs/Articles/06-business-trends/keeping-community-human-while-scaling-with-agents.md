...
我想为不同的任务使用不同的模型，让我们的 agent 访问我们的文档和社区，并允许它在失败时暂停、恢复和恢复。我没有从头开始构建所有这些，而是向我的 coding agent 描述了我需要什么，最终选择了 [AI Gateway](https://vercel.com/docs/ai-gateway)、[AI SDK](https://vercel.com/docs/ai/ai-sdk) 和 [Vercel Workflows](https://vercel.com/docs/workflow)，它们已经处理了这些复杂性。
